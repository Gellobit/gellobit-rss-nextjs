...
## [1.0.0-alpha.49] - 2026-02-01

### Added
- **Dashboard: Currently Published counter**: New highlighted card showing the total number of currently published opportunities (status='published')
  - Displayed with green gradient background for easy visibility
  - Shows real-time count of active opportunities
  - Stats row now has 5 cards: System Status, Currently Published, Today's Activity, This Week, Total Posts

### Changed
- Updated "Total Posts" description to clarify it includes all statuses

## [1.0.0-alpha.48] - 2026-02-01

### Changed
- **Dashboard: Show all opportunity types**: The "Published Opportunities by Type" section now displays all 11 opportunity types, including those with 0 published posts
  - Types shown: contest, giveaway, sweepstakes, dream_job, get_paid_to, instant_win, job_fair, scholarship, volunteer, free_training, promo

## [1.0.0-alpha.47] - 2026-02-01

### Added
- **Dashboard: Published Opportunities by Type**: New section in the admin dashboard showing the count of published opportunities grouped by opportunity type (giveaway, scholarship, free_training, etc.)
  - Color-coded cards for each opportunity type for easy visual identification
